...
#### 10B 主持投影體驗（L；課堂臨場感核心）——**已完成（2026-07-22；migration `20260724000200_live_presenter`、pgTAP 041、plan `docs/superpowers/plans/2026-07-22-live-10b-presenter.md`）**
...
#### 10D 學生端體驗（M）——**已完成（2026-07-22；migration `20260724000300_live_student_experience`、pgTAP 042、spec/05 §Live 10D）**
