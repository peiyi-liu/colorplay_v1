...
select throws_ok(
  ...
  '42501',
  null,
  'anonymous cannot execute assessment question analysis'
);
select throws_ok(
  ...
  '42501',
  null,
  'anonymous cannot execute classroom overview'
);
select throws_ok(
  ...
  '42501',
  null,
  'anonymous cannot execute Live history projection'
);
select throws_ok(
  ...
  '42501',
  null,
  'anonymous cannot execute student progress projection'
);
select throws_ok(
  ...
  '42501',
  null,
  'anonymous cannot execute internal assessment facts'
);
reset role;
...
values
  ...
  (
    ...
    '2a800000-0000-0000-0000-000000000002',
    '2a700000-0000-0000-0000-000000000002',
    'student', 'active', now(), now(), '2a900000-0000-0000-0000-000000000004'
  );
