...
const quarantineRows = (resource, columns, surface = 'none') =>
  columns.map((column) => ({
    resource,
    domain: 'content',
    surface,
...
const FORWARD_CATALOG_ROWS = [
  ...
  ...quarantineRows('assessment_banks', [
    'chapter_id',
    'created_at',
    'created_by',
    'description',
  ...
  ...quarantineRows('chapters', ['created_by', 'version'], 'browser'),
  ...quarantineRows('content_draft_requests', [
    'actor_user_id',
    'auth_session_id',
    'created_at',
    'draft_id',
  ...
  ...quarantineRows('content_import_runs', [
    'actor_user_id',
    'auth_session_id',
    'commit_request_id',
    'committed_at',
  ...
  ...quarantineRows('content_import_upload_runs', [
    'actor_user_id',
    'auth_session_id',
    'created_at',
    'expires_at',
  ...
  ...quarantineRows('content_media_assets', [
    'created_by',
    'has_alpha',
    'height',
    'id',
  ...
  ...quarantineRows('content_media_upload_runs', [
    'actor_user_id',
    'asset_id',
    'auth_session_id',
    'created_at',
  ...
  ...quarantineRows('content_media_variants', [
    'asset_id',
    'bytes',
    'height',
    'kind',
  ...
  ...quarantineRows('content_publication_requests', [
    'actor_user_id',
    'auth_session_id',
    'created_at',
    'request_hash',
  ...
  ...quarantineRows('courses', ['created_by', 'version'], 'browser'),
  ...quarantineRows(
    'questions',
  ...
  ...quarantineRows('review_cards', ['created_by'], 'browser'),
  ...quarantineRows('sections', ['created_by', 'version'], 'browser'),
  ...quarantineRows('subtopics', ['created_by', 'version'], 'browser'),
];
