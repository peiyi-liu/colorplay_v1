...
async function runSetup(page, browser, screen) {
  ...
  // UAT 0727 R2 #1：/app/leaderboard 已直達自己班級的排行榜——無需 setup，
  // 由主迴圈直接 goto（回 undefined 走 resolveRoute）。
  // DC classrooms（我的班級清單）畫面已自產品路由移除（註冊即入班）。
  if (screen.id === 'classrooms') {
    return { skipped: 'route-removed-uat-r2' };
  }
